			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">COURRIER 
						...
						<a href="liste_courrier.php" class="btn btn-primary"><span class="glyphicon glyphicon-arrow-left"></span> Retour</a>
					...
					<div class="panel-body">
						...
						<form role="form" action="ajout_courrier.php" method="post" enctype="multipart/form-data"> 
								...
								<div class="form-group">
									...
									<a target="_blank" href="docCour/<?php echo $data['docCour']?>" downlaod="<?php echo $data['docCour']?>"> <?php echo $data['docCour']?></a>
								</div>
