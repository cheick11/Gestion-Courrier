...
<body>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">COURRIER 
						...
						<a href="espace_agent.php" class="btn btn-primary"><span class="glyphicon glyphicon-arrow-left"></span> Retour</a>
   ...
   download="Pacman_Kiwi">Télécharger l'image</a>-->
   				<a href="docCour/<?php echo $data['docCour']?>"
   download="<?php echo $data['docCour']?>"><?php echo $data['docCour']?></a>
