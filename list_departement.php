...
if (!empty($_SESSION['idAgent'])) { //pour bloque acess en retour via la touche precedent
	include('connexion.php');
		...
		$reponse = $cnx->query('SELECT idDepartement, nomDepartement, telDepartement FROM departement');

		$departements = "";
		while ($data = $reponse->fetch()) {

			$departements .= '<tr><td>'.$data["idDepartement"].'</td><td>'.$data["nomDepartement"].'</td><td>'.$data["telDepartement"].'</td></tr>';
		}        
...
<body>
	...
	<?php include 'nbb_bar.php';?>				
		...
		<div class="row">
			<div class="col-lg-12">
		<h1 class="page-header"><strong>Departement </strong><a href="create_departement.php" class="btn btn-success btn-lg"><span class="glyphicon glyphicon-plus "></span> Ajouter</a> </h1>
			</div>
		</div><!--/.row-->
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table class="table table-striped table-bordered" data-toggle="table"   data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    <thead>
						    <tr>
						        <th data-sortable="true">N° departement</th>
						        <th data-sortable="true">Nom Departement</th>
						        <th data-sortable="true">Téléphone Depatement</th>
						    </tr>
						    </thead>
