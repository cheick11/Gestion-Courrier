 ...
 if(!empty($_POST['idCour'])) 
    {
		...
		$courrier .=' <form class="form" action="liste_courrier.php" role="form" method="post"><tr><td>' .$data["idCour"]. '</td><td>' .$data["expCour"]. '</td><td>' .$data["objetCour"]. '</td><td>' .$data["date_Arriver"]. '</td><td>' .$data["nomDepartement"]. '</td><td>' .$data["etat"]. '</td><td>' .$data["docCour"]. '</td><td>' .$data["titre"]. '</td><td>' .$data["commentaire"]. '</td> <td width="1200">
						    		...
						    		<td width="1200">	<a class="btn btn-primary"href="update.php"><span class="glyphicon glyphicon-pencil"></span> Modifier</a> </td>
